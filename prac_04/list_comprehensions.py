...
lower_names = [name.lower() for name in full_names]
print(lower_names)
...
# numbers =
integers_list = [int(number) for number in almost_numbers]
print(integers_list)

# TODO: use a list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
greater_than_9 = [number for number in integers_list if number > 9]
